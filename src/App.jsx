...
const Hero = () => (
  <div style={{position:"relative",height:420,overflow:"hidden"}}>
    ...
    <div style={{position:"absolute",bottom:0,left:0,right:0,height:100,background:"linear-gradient(to top, #f5f0e8, transparent)"}} />
  </div>
);

const QuoteBanner = () => (
  <div style={{maxWidth:900,margin:"-90px auto 0",position:"relative",zIndex:5,background:"#fff",border:"1px solid #e0d8cc",borderRadius:12,padding:"28px 36px",textAlign:"center",boxShadow:"0 2px 8px rgba(0,0,0,0.06)"}}>
...
const Attractions = ({ onNavigate }) => (
  <div style={{maxWidth:900,margin:"0 auto",padding:"50px 30px 10px"}}>
...
const Accommodations = () => (
  <div style={{maxWidth:900,margin:"0 auto",padding:"50px 30px 10px"}}>
    <h2 style={{fontSize:30,fontWeight:700,color:darkGreen,textAlign:"center",marginBottom:28,fontStyle:"italic"}}>Accommodations</h2>
...
const ParkMap = () => (
  <div style={{padding:"50px 0 0"}}>
    <h2 style={{fontSize:22,fontWeight:700,color:darkGreen,textAlign:"center",marginBottom:20,fontStyle:"italic"}}>Theme Park Map</h2>
          ...
          <div style={{display:"flex",flexWrap:"wrap",gap:10,marginBottom:22}}>
            {Object.entries(interests).map(([k,v])=>(
              <span key={k} onClick={()=>setInterests(p=>({...p,[k]:!p[k]}))}
                style={{padding:"8px 22px",border:`1.5px solid ${v?darkGreen:"#bbb"}`,borderRadius:6,fontSize:13,fontWeight:600,
          ...
          <div style={{display:"flex",flexWrap:"wrap",gap:12,marginBottom:14}}>
            <div style={{flex:"1 1 160px",minWidth:160}}>
              ...
              <input type="date" value={arrival} min={today} onChange={e=>setArrival(e.target.value)}
                style={{width:"100%",padding:"8px 12px",border:`1.5px solid ${arrival?darkGreen:"#bbb"}`,borderRadius:6,fontSize:13,
            ...
            <div style={{flex:"1 1 160px",minWidth:160}}>
              ...
              <input type="date" value={departure} min={arrival||today} onChange={e=>setDeparture(e.target.value)}
                style={{width:"100%",padding:"8px 12px",border:`1.5px solid ${departure?darkGreen:"#bbb"}`,borderRadius:6,fontSize:13,
...
const BookButton = ({ provider, url }) => (
  <a href={url} target="_blank" rel="noopener noreferrer"
    style={{background:darkGreen,color:"#fff",border:"none",padding:"10px 22px",borderRadius:6,fontSize:12,fontWeight:700,cursor:"pointer",
...
const TripPlannerResults = ({ selections, onBack, onNavigate, onHome }) => {
  ...
  return (
    <div style={{animation:"pageIn 0.4s ease"}}>
      ...
      <div style={{maxWidth:900,margin:"0 auto",padding:"40px 30px 10px"}}>
      ...
      {/* Booking Sections */}
      <div style={{maxWidth:900,margin:"0 auto",padding:"30px 30px 50px"}}>
              ...
              {[ticketData[1]].map(t=>(
                <BookingCard key={t.name}>
                  ...
                  <div style={{textAlign:"right",minWidth:140}}>
                    ...
                    <a href={t.url} style={{background:gold,color:"#fff",border:"none",padding:"10px 22px",borderRadius:6,fontSize:12,fontWeight:700,cursor:"pointer",
      ...
      {/* Back Button */}
      <div style={{maxWidth:900,margin:"0 auto",padding:"0 30px 40px",textAlign:"center"}}>
...
const TripPlannerResultsVariation = ({ selections, onBack, showDescription = true, onNavigate, onHome }) => {
  ...
  return (
    <div style={{animation:"pageIn 0.4s ease"}}>
      ...
      {/* 3 Itinerary Cards */}
      <div style={{maxWidth:1000,margin:"0 auto",padding:"40px 30px 10px"}}>
      ...
      {currentItinerary && selectedInterests.length > 0 && (
        <div key={selectedItinerary} style={{maxWidth:1000,margin:"0 auto",padding:"40px 30px 50px",animation:"slideUp 0.35s ease"}}>
            ...
            {interests.Tickets && (
              <BookingCard>
                ...
                <div style={{textAlign:"right",minWidth:140}}>
                  ...
                  <a href={currentItinerary.ticket.url} style={{background:gold,color:"#fff",border:"none",padding:"10px 22px",borderRadius:6,fontSize:12,fontWeight:700,cursor:"pointer",
                    fontFamily:"Helvetica,Arial,sans-serif",textDecoration:"none",display:"inline-block",transition:"all 0.2s"}}
                    onMouseEnter={e=>{e.currentTarget.style.transform="translateY(-1px)";e.currentTarget.style.boxShadow="0 4px 12px rgba(201,169,110,0.4)";}}
                    onMouseLeave={e=>{e.currentTarget.style.transform="";e.currentTarget.style.boxShadow="";}}>
                    Buy Tickets
      ...
      {/* Back Button */}
      <div style={{maxWidth:1000,margin:"0 auto",padding:"0 30px 40px",textAlign:"center"}}>
        <button onClick={onBack}
          style={{background:"#fff",color:darkGreen,border:`2px solid ${darkGreen}`,padding:"12px 36px",borderRadius:8,fontSize:14,fontWeight:700,cursor:"pointer",fontFamily:"Helvetica,Arial,sans-serif",transition:"all 0.2s"}}
          onMouseEnter={e=>{e.currentTarget.style.background=darkGreen;e.currentTarget.style.color="#fff";}}
          onMouseLeave={e=>{e.currentTarget.style.background="#fff";e.currentTarget.style.color=darkGreen;}}>
...
/* ─── Inner Page Template ─── */
const InnerPage = ({ onNavigate, onBack, onHome, title, children }) => (
  <div style={{animation:"pageIn 0.4s ease"}}>
    <Nav onNavigate={onNavigate} onHome={onHome} />
    {/* Page hero */}
    ...
    <div style={{maxWidth:900,margin:"0 auto",padding:"40px 30px 50px"}}>{children}</div>
    {/* Back */}
    <div style={{maxWidth:900,margin:"0 auto",padding:"0 30px 40px",textAlign:"center"}}>
      <button onClick={onBack}
        style={{background:"#fff",color:darkGreen,border:`2px solid ${darkGreen}`,padding:"12px 36px",borderRadius:8,fontSize:14,fontWeight:700,cursor:"pointer",fontFamily:"Helvetica,Arial,sans-serif",transition:"all 0.2s"}}
        ...
        <div key={a.title} style={{background:"#fff",borderRadius:10,overflow:"hidden",border:"1px solid #e0d8cc"}}>
          ...
          <div style={{padding:"20px 22px"}}>
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8}}>
              ...
              <span style={{background:a.thrill==="Extreme"?"#c0392b":a.thrill==="High"?"#e67e22":a.thrill==="Moderate"?darkGreen:"#27ae60",
                color:"#fff",padding:"3px 10px",borderRadius:12,fontSize:10,fontWeight:700,fontFamily:"Helvetica,Arial,sans-serif"}}>{a.thrill}</span>
            </div>
...
const PlanVisitPage = ({ onNavigate, onBack, onHome, onStartPlanning }) => {
  ...
  return (
    <div style={{animation:"pageIn 0.4s ease"}}>
      ...
      {/* Intro / Guide section */}
      <div style={{maxWidth:900,margin:"0 auto",padding:"40px 30px 0"}}>
      ...
      <div style={{maxWidth:900,margin:"0 auto",padding:"0 30px 50px"}}>
      ...
      {/* Back */}
      <div style={{maxWidth:900,margin:"0 auto",padding:"30px 30px 40px",textAlign:"center"}}>
        <button onClick={onBack}
          style={{background:"#fff",color:darkGreen,border:`2px solid ${darkGreen}`,padding:"12px 36px",borderRadius:8,fontSize:14,fontWeight:700,cursor:"pointer",fontFamily:"Helvetica,Arial,sans-serif",transition:"all 0.2s"}}
          onMouseEnter={e=>{e.currentTarget.style.background=darkGreen;e.currentTarget.style.color="#fff";}}
          onMouseLeave={e=>{e.currentTarget.style.background="#fff";e.currentTarget.style.color=darkGreen;}}>
...
const Sidebar = ({ items, activeId, onSelect, sidebarCollapsed, setSidebarCollapsed, sectionLabel, footerLabel, onBackToLanding }) => {
  ...
  return (
    <div style={{width:sW,flexShrink:0,background:"#1a2e1a",display:"flex",flexDirection:"column",
      position:"fixed",top:0,left:0,bottom:0,zIndex:100,transition:"width 0.3s ease",overflow:"hidden",
      boxShadow:"2px 0 20px rgba(0,0,0,0.3)"}}>
      <div style={{padding:sidebarCollapsed?"16px 0":"20px 20px",display:"flex",alignItems:"center",justifyContent:sidebarCollapsed?"center":"space-between",
        ...
        <button onClick={()=>setSidebarCollapsed(!sidebarCollapsed)}
          style={{background:"rgba(255,255,255,0.08)",border:"none",color:gold,width:28,height:28,borderRadius:6,
        ...
        {items.map(item => {
          ...
          return (
            <div key={item.id} onClick={()=>onSelect(item.id)}
              style={{padding:sidebarCollapsed?"12px 0":"12px 20px",cursor:"pointer",display:"flex",alignItems:"center",
              ...
              {!sidebarCollapsed && (
                <div>
                  <div style={{color:active?gold:"rgba(255,255,255,0.7)",fontSize:13,fontWeight:active?700:500,
                    fontFamily:"Helvetica,Arial,sans-serif",whiteSpace:"nowrap"}}>{item.label}</div>
                  <div style={{color:active?"rgba(201,169,110,0.6)":"rgba(255,255,255,0.35)",fontSize:10,marginTop:2,
                    fontFamily:"Helvetica,Arial,sans-serif",whiteSpace:"nowrap"}}>{item.desc}</div>
                </div>
              )}
            </div>
          );
      ...
      <div style={{padding:sidebarCollapsed?"12px 0":"12px 20px",borderTop:"1px solid rgba(201,169,110,0.15)"}}>
        <div onClick={onBackToLanding}
          style={{padding:sidebarCollapsed?"8px 0":"8px 14px",cursor:"pointer",display:"flex",alignItems:"center",
...
const SectionLabel = ({ children }) => (
  <span style={{display:"inline-block",fontSize:10,fontWeight:700,letterSpacing:1.5,textTransform:"uppercase",color:gold,fontFamily:"Helvetica,Arial,sans-serif",
    background:"rgba(201,169,110,0.1)",padding:"4px 10px",borderRadius:4,marginBottom:10}}>{children}</span>
);

const LandingPage = ({ onSelectTest }) => (
  <div style={{minHeight:"100vh",fontFamily:"Georgia,serif",
    backgroundImage:`url(${IMG.bg})`,backgroundSize:"cover",backgroundAttachment:"fixed"}}>

    {/* Hero header */}
    <div style={{position:"relative",overflow:"hidden",padding:"70px 30px 60px",textAlign:"center"}}>
      <img src={IMG.hero} alt="" style={{position:"absolute",top:0,left:0,width:"100%",height:"100%",objectFit:"cover",display:"block"}} />
    ...
    {/* Background context */}
    <div style={{maxWidth:900,margin:"0 auto",padding:"40px 30px 10px",animation:"slideUp 0.5s ease 0.1s both"}}>
    ...
    <div style={{maxWidth:900,margin:"0 auto",padding:"32px 30px 0",textAlign:"center",animation:"slideUp 0.5s ease 0.2s both"}}>
    ...
    {/* Two test cards */}
    <div style={{maxWidth:900,margin:"0 auto",padding:"20px 30px 60px",animation:"slideUp 0.5s ease 0.3s both"}}>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:28}}>

        {/* Test 1 Card */}
        <div onClick={()=>onSelectTest("test1")}
          style={{background:"#fff",border:`2px solid ${gold}`,borderRadius:14,overflow:"hidden",cursor:"pointer",
...
export default function TimberMountainApp() {
  ...
  if (currentView === "attractions") {
    return (
      <div style={{minHeight:"100vh",fontFamily:"Georgia,serif",backgroundImage:`url(${IMG.bg})`,backgroundSize:"cover",backgroundAttachment:"fixed"}}>
  ...
  if (currentView === "test2") {
    ...
    return (
      <div style={{display:"flex",minHeight:"100vh",fontFamily:"Georgia,serif"}}>
        ...
        <div style={{flex:1,marginLeft:sW,transition:"margin-left 0.3s ease",
          backgroundImage:`url(${IMG.bg})`,backgroundSize:"cover",backgroundAttachment:"fixed"}}>
